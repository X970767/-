        ...
        <div class="order-right">
          <div class="order-content">
                  ...
                  <tr v-for="(cart,index) in order.orderDetailList" :key="cart.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="cart.imgUrl" style="wight:100px;height:100px">
                        <a href="#" class="block-text">{{cart.skuName}}</a>
                        <span>x{{cart.skuNum}}</span>
                        <a href="#" class="service">售后申请</a>
                      </div>
                    </td>
                    <td :rowspan="order.orderDetailList.length" v-if="index===0" class="center">小丽</td>
            ...
            <div class="choose-order">
                <Pagination :pageNo="page" :pageSize="limit" :total="myOrder.total" :continues="2" @getPageno="getPageno"/>
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
