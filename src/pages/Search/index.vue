      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(attrValue,index) in searchParams.props" :key="index">{{attrValue.split(":")[1]}}<i @click="removeattrInfo(index)">×</i></li>
          </ul>
        </div>
          ...
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                ...
                <li :class="{active:(isTwo && isasc)}" @click="changOrder('2')">
                  <a v-show="!(isTwo && isdesc)">价格<span v-show="isTwo && isasc">⬆</span></a>
                </li>
                <li :class="{active:(isTwo && isdesc)}" @click="changOrder('2')">
                  <a v-show="isTwo && isdesc">价格⬇</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      changOrder(flag) {
        if(this.searchParams.order.indexOf(flag)!==-1) {
          ...
          }else {this.searchParams.order = `${flag}:asc`}
        }
        else {
          if(this.searchParams.order.indexOf('asc')!==-1) {
            this.searchParams.order = `${flag}:desc`
    ...
    watch:{
        ...
        $route(newValue,OldValue){
          this.searchParams.keyword = this.$route.query
          if(typeof(this.searchParams.keyword)==='string') {
            Object.assign(this.searchParams,this.$route.params);
          }else {
