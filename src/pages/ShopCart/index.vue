  ...
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart,index) in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="cart.isChecked===1" @change="Checked(cart,$event)">
          </li>
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteCar(cart)">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked="isAllCheck&&cartInfoList.length>0" @click="allChecked">
        <span>全选</span>
      </div>
      <div class="option">
        <a @click="deleteAllCar">删除选中的商品</a>
  ...
  export default {
    ...
    methods: {
      ...
      async deleteCar(cart) {
        try {
          await this.$store.dispatch('deleteCar',cart.skuId)
          this.getData()
        } catch (error) {
          alert(error.message)
        }
      ...
      Checked(cart,event) {
        try {
          ...
          this.$store.dispatch('byid',{skuId:cart.skuId,isChecked})
          this.getData()
        } catch (error) {
          alert(error.message)
        }
